let bntlight=document.getElementById('bntlight');
bntlight.addEventListener('click', tonight);
function tonight(){
    document.body.classList.toggle('modnight');
}
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents =  
    ` <div class="cart-item cart-column cart-col">
    <img class="cart-item-image" src="${imageSrc}" width="100" height="100">
    <span id="titre-card-modal" class="cart-item-title">${title}</span>
</div>
